...
namespace HugoMundo6
{
    public class Tree
    {
        ...
        public Tree(GraphicsDevice device, Game game, Vector3 position)
        {
            ...
            {
                new VertexPositionTexture(new Vector3(-5,10,0), Vector2.Zero),
                new VertexPositionTexture(new Vector3(5,10,0), Vector2.UnitX),
                new VertexPositionTexture(new Vector3(-5,-10,0), Vector2.UnitY),
                new VertexPositionTexture(new Vector3(5,-10,0), Vector2.One),
            };
